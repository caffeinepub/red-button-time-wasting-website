...
function App() {
  ...
  const [isExploding, setIsExploding] = reactExports.useState(false);
  const handleClick = (e) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col items-center justify-center bg-background relative overflow-hidden", children: [
    isExploding && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 animate-flash bg-white" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-40 animate-shake", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 animate-explosion-1 bg-gradient-radial from-red-500 via-orange-500 to-yellow-500 opacity-80" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 animate-explosion-2 bg-gradient-radial from-yellow-400 via-red-600 to-purple-600 opacity-70" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 animate-explosion-3 bg-gradient-radial from-orange-500 via-pink-500 to-red-700 opacity-60" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-80", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            role: "presentation",
            "aria-hidden": "true",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-12 left-0 right-0 flex flex-col items-center gap-4 z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-5xl font-bold text-foreground tracking-tight", children: "Do Not Press" }),
      !isExploding && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl md:text-3xl font-semibold text-muted-foreground", children: [
        "Clicks: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: clickCount })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        style: {
          ...
          boxShadow: isPressed ? "0 5px 20px -5px rgba(220,38,38,0.4)" : "0 10px 40px -10px rgba(220,38,38,0.5), 0 0 0 1px rgba(220,38,38,0.1)"
        },
        className: `
        ...
        children: [
          isPressed && !isExploding && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 rounded-full bg-white/20 animate-ping" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10", children: "Do Not Press" })
        ]
      }
    )
  ] });
